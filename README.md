...
## Loopback control API (v1.3 PR 6)
...
read-only dired, and bounded file reads. The browser UI and filesystem
...
`127.0.0.1`; direct non-loopback binding and TLS are not part of PR 6. See
