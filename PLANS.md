...
Other remaining agent work (unchanged priority relative to product need): plan/security/refactor task-mode prompt selection, `find_callers` / `find_callees`, transcript as sole TUI source of truth, stronger editor↔agent handoff.
