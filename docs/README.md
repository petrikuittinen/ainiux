...
| [Control API](api.md) | Start the loopback-by-default v1.3 server; configure TLS/direct access; use jobs, sessions, revision-safe chat threads, read-only workspace routes, and MCP |
