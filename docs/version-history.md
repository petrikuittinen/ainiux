...
| v1.34 | PDF↔Markdown conversion is hardened for hostile, malformed, and oversized input: bounded recursive/object/page traversal, checked numeric and stream ranges, stable object storage, complete Flate validation, and deterministic text geometry. The local C++17 PDF reader and Markdown writer remain exceptionally fast, with focused adversarial, sanitizer, and corpus performance coverage. |
