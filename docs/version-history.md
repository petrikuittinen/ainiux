...
| Unreleased | Native Windows 10 1903+/Windows 11 x64 UCRT64 target remains gated on native parity. CLI image generation is landed. v1.3 PR 8 adds optional OpenSSL TLS, gated direct non-loopback access, strict Host/Origin policy, and remote-Yolo isolation. |
