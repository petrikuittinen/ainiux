...
| Unreleased | Native Windows 10 1903+/Windows 11 x64 UCRT64 target remains gated on native parity. CLI image generation is landed. v1.3 PR 4 adds the authenticated stateless MCP 2026-07-28 adapter, deterministic job tools, MCP-only scope, and bounded task handles on top of the PR 3 loopback control API. |
