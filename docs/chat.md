...
Core commands include `/help`, `/new`, `/list`, `/edit`, `/provider`, `/model`, `/system`, `/setting`, `/clone`, `/save`, `/load`, `/remove`, `/pop`, `/response`, `/insert`, `/attach`, `/fetch`, `/chat-to-pdf`, `/last-to-pdf`, `/search`, `/theme`, `/scrollbar`, and `/thinking`.
