...
PDF input is converted to Markdown locally; raw PDF bytes are not sent as prompt text. DOCX is not read as text or uploaded. Markdown-to-PDF writing remains later work.
