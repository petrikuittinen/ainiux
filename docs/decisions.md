...
DOCX remains an unsupported binary type. PDF input converts to Markdown in `src/pdf/` rather than inserting binary prompt text. Markdown-to-PDF writing is a later slice.
