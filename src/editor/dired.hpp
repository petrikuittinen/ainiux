...
// Open-for-edit shortcuts are focus-sensitive: o works everywhere while e is
// reserved for the read-only preview.
...
inline constexpr const char kDiredViewHelp[] =
    "e edit, space/PageDown down, PageUp/b back, n next dirty block, p previous dirty block, q quit";
