...
ThemePalette light_palette() {
    ...
    palette.syntax_comment = {0x4B, 0x55, 0x63};
    palette.syntax_keyword = {0x6D, 0x28, 0xD9};
    palette.syntax_type = {0x07, 0x59, 0x85};
    palette.syntax_string = {0x16, 0x65, 0x34};
    palette.syntax_number = {0x92, 0x40, 0x0E};
    palette.syntax_literal = {0x9F, 0x12, 0x39};
    palette.syntax_function = {0x1D, 0x4E, 0xD8};
    palette.syntax_variable = {0x9D, 0x17, 0x4D};
    palette.syntax_operator = {0x11, 0x18, 0x27};
    palette.syntax_preprocessor = {0x86, 0x19, 0x8F};
    palette.syntax_tag = {0x15, 0x5E, 0x75};
    palette.syntax_attribute = {0x85, 0x4D, 0x0E};
    palette.syntax_property = {0x43, 0x38, 0xCA};
    palette.syntax_heading = {0x9D, 0x17, 0x4D};
    palette.syntax_emphasis = {0x9A, 0x34, 0x12};
    palette.syntax_link = {0x07, 0x59, 0x85};
    return palette;
}
